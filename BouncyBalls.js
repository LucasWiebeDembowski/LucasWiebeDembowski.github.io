...
function resizeCanvasToDisplaySize(canvas) {
    ...
    rectHeight = 0.15*canvas.height;
    rectWidth = 0.10*canvas.height;
    rectX = -0.5*rectWidth;
    rectY = canvas.height - rectHeight;
    for(object of objects) {
        object.radius = 0.05*canvas.height;
        object.x = object.x * canvas.width / oldCanvasWidth;
        object.y = object.y * canvas.height / oldCanvasHeight;
    }
